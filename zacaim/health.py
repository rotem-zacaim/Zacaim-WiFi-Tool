...
class ToolInstaller:
    ...
    MANUAL_TOOL_NOTES = {
        ...
        "dnsx": "Install manually from the ProjectDiscovery release or Go toolchain.",
        "naabu": "Install manually from the ProjectDiscovery release or Go toolchain.",
        "subfinder": "Install manually from the ProjectDiscovery release or Go toolchain.",
        "gau": "Install manually from the gau release or Go toolchain.",
        "enum4linux-ng": "Install manually from the enum4linux-ng project.",
        "rdpscan": "Install manually from the upstream release or your preferred security tools repo.",
    }
